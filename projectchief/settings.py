"""
Django settings for projectchief project.
...
SECRET_KEY = "django-insecure-v62rhf06)dr9x!381^+)0ra9t*(7$r7a9@^qvnk!t2jkqr5ga#"
...
WSGI_APPLICATION = "projectchief.wsgi.application"
